...
public class WCPay {
    ...
    public WCPay(WCPay pay,String paymentid1)
    {
        this.appId = pay.appId;
        this.timeStamp = pay.timeStamp;
        this.nonceStr = pay.nonceStr;
        this.packages = pay.packages;
        this.paySign = pay.paySign;
